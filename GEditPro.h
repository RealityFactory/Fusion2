...
#define TEMPLATE_RESOURCE_ID			IDR_GEDITPROTYPE
#define TEMPLATE_DOC_CLASS				RUNTIME_CLASS( CGEditProDoc )
#define TEMPLATE_CHILD_FRAME_CLASS		RUNTIME_CLASS( CChildFrame )
#define TEMPLATE_VIEW_CLASS				RUNTIME_CLASS( CGEditProView )

#define GEDITPRO_INIFILE_NAME "RFEditPro.ini"	//	new g3dc

class CGEditProApp : public CWinApp
{
public:
	...
	CGEditProApp();
	~CGEditProApp();
	CGEditProDoc * GetActiveGenEditDoc( void ) const ;
